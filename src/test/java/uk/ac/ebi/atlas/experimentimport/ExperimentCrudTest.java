...
public class ExperimentCrudTest {
    ...
    public void failImportOnValidationWhenExperimentDesignDoesNotMatchAssayGroups() {
    ...
    @Test(expected = IllegalStateException.class)
    public void failImportOnValidationWhenExperimentDesignDoesNotMatchAssayGroups2() {
    ...
    @Test
    public void importExperimentParsesDesignFileOnce() {
        subject.importExperiment(EXPERIMENT_ACCESSION, false);
