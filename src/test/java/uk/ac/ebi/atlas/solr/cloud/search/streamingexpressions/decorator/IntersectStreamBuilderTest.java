...
class IntersectStreamBuilderTest {
    ...
    private final TupleStreamBuilder tupleStreamBuilderC = DummyTupleStreamBuilder.create(streamC, SORT_FIELD, true);
    private final TupleStreamBuilder tupleStreamBuilderD = DummyTupleStreamBuilder.create(streamD, SORT_FIELD, true);
