...
public class BioentitiesCollectionProxy extends CollectionProxy<BioentitiesCollectionProxy> {
    // Where, and in what order, we should search in case of a free text query (without category)
    ...
    // because they didn’t notice and their intent is clear (or even that they chose a species but when typing and saw
    // the suggestions they changed her mind). After all, they’re the geneticist/biologist/bioinformatician!
